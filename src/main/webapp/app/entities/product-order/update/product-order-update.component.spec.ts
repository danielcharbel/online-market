...
describe('ProductOrder Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Product query and add missing value', () => {
      ...
      const product: IProduct = { id: 12559 };
      productOrder.product = product;

      const productCollection: IProduct[] = [{ id: 20757 }];
    ...
    it('Should call ShoppingCart query and add missing value', () => {
      const productOrder: IProductOrder = { id: 456 };
      const cart: IShoppingCart = { id: 2888 };
      productOrder.cart = cart;

      const shoppingCartCollection: IShoppingCart[] = [{ id: 27785 }];
    ...
    it('Should update editForm', () => {
      const productOrder: IProductOrder = { id: 456 };
      const product: IProduct = { id: 5664 };
      productOrder.product = product;
      const cart: IShoppingCart = { id: 32596 };
      productOrder.cart = cart;
