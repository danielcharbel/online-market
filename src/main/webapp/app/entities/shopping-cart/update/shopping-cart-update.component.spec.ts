...
describe('ShoppingCart Management Update Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, RouterTestingModule.withRoutes([]), ShoppingCartUpdateComponent],
      providers: [
        FormBuilder,
        {
  ...
  describe('ngOnInit', () => {
    it('Should call CustomerDetails query and add missing value', () => {
      ...
      const customerDetails: ICustomerDetails = { id: 6709 };
      shoppingCart.customerDetails = customerDetails;

      const customerDetailsCollection: ICustomerDetails[] = [{ id: 9782 }];
    ...
    it('Should update editForm', () => {
      const shoppingCart: IShoppingCart = { id: 456 };
      const customerDetails: ICustomerDetails = { id: 31425 };
      shoppingCart.customerDetails = customerDetails;
