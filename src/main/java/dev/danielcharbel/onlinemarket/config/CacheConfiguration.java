...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, dev.danielcharbel.onlinemarket.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, dev.danielcharbel.onlinemarket.repository.UserRepository.USERS_BY_EMAIL_CACHE);
