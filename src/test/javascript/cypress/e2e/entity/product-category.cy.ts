...
describe('ProductCategory e2e test', () => {
  ...
  const productCategorySample = { name: 'ack feisty' };
  ...
  describe('new ProductCategory page', () => {
    ...
    it('should create an instance of ProductCategory', () => {
      cy.get(`[data-cy="name"]`).type('slushy jaggedly');
      cy.get(`[data-cy="name"]`).should('have.value', 'slushy jaggedly');

      cy.get(`[data-cy="description"]`).type('drizzle');
      cy.get(`[data-cy="description"]`).should('have.value', 'drizzle');
