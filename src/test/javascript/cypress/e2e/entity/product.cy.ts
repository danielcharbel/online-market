...
describe('Product e2e test', () => {
  ...
  const productSample = { name: 'following', price: 30168.11, productSize: 'XL' };
  ...
  beforeEach(() => {
    ...
    cy.authenticatedRequest({
      ...
      body: { name: 'uh-huh nor', description: 'till discontinue' },
    }).then(({ body }) => {
  ...
  describe('new Product page', () => {
    ...
    it('should create an instance of Product', () => {
      cy.get(`[data-cy="name"]`).type('courteous congress riposte');
      cy.get(`[data-cy="name"]`).should('have.value', 'courteous congress riposte');

      cy.get(`[data-cy="description"]`).type('minnow beside pace');
      cy.get(`[data-cy="description"]`).should('have.value', 'minnow beside pace');

      cy.get(`[data-cy="price"]`).type('8440.17');
      cy.get(`[data-cy="price"]`).should('have.value', '8440.17');
