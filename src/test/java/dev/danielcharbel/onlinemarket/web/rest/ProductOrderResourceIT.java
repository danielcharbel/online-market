...
import dev.danielcharbel.onlinemarket.domain.ProductOrder;
import dev.danielcharbel.onlinemarket.domain.ShoppingCart;
import dev.danielcharbel.onlinemarket.repository.ProductOrderRepository;
import dev.danielcharbel.onlinemarket.service.ProductOrderService;
...
class ProductOrderResourceIT {
    ...
    void partialUpdateProductOrderWithPatch() throws Exception {
        ...
        partialUpdatedProductOrder.totalPrice(UPDATED_TOTAL_PRICE);
