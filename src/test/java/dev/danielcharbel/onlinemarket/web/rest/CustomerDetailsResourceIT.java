...
import dev.danielcharbel.onlinemarket.domain.enumeration.Gender;
import dev.danielcharbel.onlinemarket.repository.CustomerDetailsRepository;
import dev.danielcharbel.onlinemarket.service.CustomerDetailsService;
...
class CustomerDetailsResourceIT {
    ...
    void partialUpdateCustomerDetailsWithPatch() throws Exception {
        ...
        partialUpdatedCustomerDetails.phone(UPDATED_PHONE).addressLine2(UPDATED_ADDRESS_LINE_2).city(UPDATED_CITY).country(UPDATED_COUNTRY);
