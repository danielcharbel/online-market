...
import static dev.danielcharbel.onlinemarket.web.rest.TestUtil.sameNumber;
...
import dev.danielcharbel.onlinemarket.domain.CustomerDetails;
import dev.danielcharbel.onlinemarket.domain.ShoppingCart;
import dev.danielcharbel.onlinemarket.domain.enumeration.OrderStatus;
import dev.danielcharbel.onlinemarket.domain.enumeration.PaymentMethod;
import dev.danielcharbel.onlinemarket.repository.ShoppingCartRepository;
...
class ShoppingCartResourceIT {
    ...
    void partialUpdateShoppingCartWithPatch() throws Exception {
        ...
        partialUpdatedShoppingCart.placedDate(UPDATED_PLACED_DATE).status(UPDATED_STATUS).paymentMethod(UPDATED_PAYMENT_METHOD);
